...
BOT_TOKEN = environ.get('BOT_TOKEN', "6897344346:AAFiLGBxw6z3agVC4duYtzxJDk3omZMVz34")
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6626499601 1976581598').split()]
